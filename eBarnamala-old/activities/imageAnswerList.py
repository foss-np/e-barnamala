...
class imageAnswerList():
    def __init__(self, parent, answer, questionList, questionImgList):
        ...
        self.questionImage0 = statbmp(parent, wx.ID_ANY, questionImg0, (70,70), (questionImg0.GetWidth(), questionImg0.GetHeight()))
        ...
        self.questionImage1 = statbmp(parent, wx.ID_ANY, questionImg1, (200,70), (questionImg1.GetWidth(), questionImg1.GetHeight()))
        ...
        self.questionImage3 = statbmp(parent, wx.ID_ANY, questionImg3, (460,70), (questionImg3.GetWidth(), questionImg3.GetHeight()))
        ...
        self.questionImage4 = statbmp(parent, wx.ID_ANY, questionImg4, (590,70), (questionImg4.GetWidth(), questionImg4.GetHeight()))
        ...
        self.answerImage = statbmp(parent, -1, answerImg, (100,330), (180,140))
        self.answerImage.SetBackgroundColour(config.backgroundColour)

    def nextQuestion(self, answer, questionList, questionImgList):
        self.answer = answer
        self.questionList = questionList
    ...
    def checkAnswer(self):
        answer = ''
        if self.answer == self.questionList[self.buttonPressed] :
            answer = "Right"
        else:
            answer = "Wrong"
        return answer
